...
private:
	...
	Node* head_ptr = reinterpret_cast <Node*>(0xBAD10000); // Make it easy to find uninitialized ptr
};
...
{ // Node for a linked list
	...
	Item data;
	Node* link = reinterpret_cast <Node*>(0x12345678); // Make it easy to find uninitialized ptr
};
